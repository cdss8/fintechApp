...
class __TwigTemplate_8a4daab7842459dfe0c977cc38105786 extends Template
{
    ...
    <div id=\"breadcrumb\" aria-label=\"";
            ...
            yield (((($tmp = ($context["classes_breadcrumb"] ?? null)) && $tmp instanceof Markup ? (string) $tmp : $tmp)) ? ($this->extensions['Drupal\Core\Template\TwigExtension']->escapeFilter($this->env, (" " . ($context["classes_breadcrumb"] ?? null)), "html", null, true)) : (""));
            yield "\" ";
